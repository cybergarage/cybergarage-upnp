...
public class WasherPane extends JPanel // MouseListener
{
  ...
  private static final String WASHER_PANEL_IMAGE = "images/washer.jpg";
  private static final String WASHER_ANIM_IMAGE1 = "images/washeron1.jpg";
  private static final String WASHER_ANIM_IMAGE2 = "images/washeron2.jpg";
  ...
  public void flipAnimationImage() {
    if (animlmage == anim1lmage) animlmage = anim2lmage;
    else animlmage = anim1lmage;
  }
