...
public class LightPane extends JPanel {
  ...
  private static final String LIGHT_ON_PANEL_IMAGE = "images/lighton.jpg";
  private static final String LIGHT_OFF_PANEL_IMAGE = "images/lightoff.jpg";
  ...
  public void paint(Graphics g) {
    ...
    if (dev.isOn() == true) loadImage(LIGHT_ON_PANEL_IMAGE);
    else loadImage(LIGHT_OFF_PANEL_IMAGE);
