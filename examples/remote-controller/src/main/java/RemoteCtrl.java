...
public class RemoteCtrl extends ControlPoint
    implements NotifyListener, EventListener, SearchResponseListener {
  private static final String TV_DEVICE_TYPE = "urn:schemas-upnp-org:device:tv:1";
  private static final String TV_SERVICE_TYPE = "urn:schemas-upnp-org:service:power:1";
  ...
  private static final String AIRCON_SERVICE_TYPE = "urn:schemas-upnp-org:service:power:1";
  ...
  public void powerOn(String deviceType) {
    ...
    if (getPowerAct.postControlAction() == false) return;
