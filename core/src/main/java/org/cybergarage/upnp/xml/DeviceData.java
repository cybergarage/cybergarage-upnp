...
public class DeviceData extends NodeData {
  ...
  */
  ...
  public SSDPSearchSocketList getSSDPSearchSocketList() {
    if (this.ssdpSearchSocketList == null) {
      this.ssdpSearchSocketList =
          new SSDPSearchSocketList(this.ssdpBinds, ssdpPort, ssdpMulticastIPv4, ssdpMulticastIPv6);
    }
    return ssdpSearchSocketList;
  }

  /**
   * @param port The port to use for binding the SSDP service. The port will be used as source port
   *     for all SSDP messages
   * @since 1.8
   */
  ...
  /**
   * @param inets The <tt>InetAddress</tt> that will be binded for listing this service. Use <code>
   *     null</code> for the default behaviur.
   * @see {@link UPnP}
   * @see {@link USSDP}
  ...
  /**
   * @return inets The <tt>InetAddress</tt> that will be binded for this service <code>null</code>
