...
public class UPnP {
  ...
  /**
   * This method loads the default XML Parser using the following behavior: - First if present loads
   * the parsers specified by the system property {@link UPnP#XML_CLASS_PROPERTTY}<br>
