 ...
 *
 * <p>This class extends {@link SOAPRequest} to provide common functionality for both action
 * requests and state variable query requests. It handles URL resolution, including absolute and
 * relative URLs, URL base paths, and port extraction.
 *
 * @see ActionRequest
 * @see QueryRequest
 * @see SOAPRequest
...
public class ControlRequest extends SOAPRequest {
   ...
   *
   * @return {@code true} if this is a QueryStateVariable request, {@code false} otherwise
   */
   ...
   *
   * @return {@code true} if this is an action invocation request, {@code false} if it's a query
   *     request
   */
   ...
   *
   * <ul>
   *   <li>Absolute vs relative URLs
   *   <li>URL base paths from the device description
   *   <li>Port numbers in control URLs
   *   <li>Fallback to device location if URLBase is not set
   * </ul>
   *
