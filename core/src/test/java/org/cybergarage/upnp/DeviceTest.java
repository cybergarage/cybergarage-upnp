...
public class DeviceTest extends TestCase {
  ...
  public void testDeviceAbsoluteURL() {
    ...
    devAbsUrl =
        dev.getAbsoluteURL("http://192.168.0.1:80/serviceURL", "http://192.168.0.2:80/", null);
    assertTrue(devAbsUrl, devAbsUrl.equals("http://192.168.0.1:80/serviceURL"));

    /* O:serviceURLStr -:baseURLStr O:locationURLStr */
    devAbsUrl =
        dev.getAbsoluteURL("http://192.168.0.1:80/serviceURL", null, "http://192.168.0.3:80/");
    assertTrue(devAbsUrl, devAbsUrl.equals("http://192.168.0.1:80/serviceURL"));

    /* O:serviceURLStr O:baseURLStr O:locationURLStr */
    devAbsUrl =
        dev.getAbsoluteURL(
            "http://192.168.0.1:80/serviceURL", "http://192.168.0.2:80/", "http://192.168.0.3:80/");
    assertTrue(devAbsUrl, devAbsUrl.equals("http://192.168.0.1:80/serviceURL"));
  ...
  public void testAddIconNode() {
    ...
    assertTrue(dev.isIconBytesURI(url));
    devIcon = dev.getIconByURI(url);
