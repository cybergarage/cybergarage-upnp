/**
 * Provides classes and interfaces for UPnP AV (Audio/Video) controller functionality.
 * This package includes classes for managing media controllers and handling browse actions.
 * 
 * <p>
 * The main classes in this package are:
 * <ul>
 *   <li>{@link org.cybergarage.upnp.std.av.controller.MediaController} - Represents a media controller for a UPnP media server.</li>
