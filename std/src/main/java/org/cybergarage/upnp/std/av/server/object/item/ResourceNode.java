...
public class ResourceNode extends ContentNode {
  ...
  public String getProtocolInfoAtIndex(int anIndex) {
    ...
    if (protocols == null || protocols.length <= anIndex) return "";
  ...
  public String getAdditionalInfoForKey(String aKey) {
    ...
    if (fullAddInfo == null) return "";
    String addInfos[] = fullAddInfo.split(";");
    if (addInfos == null || addInfos.length <= 0) return "";
    for (int n = 0; n < addInfos.length; n++) {
      String addInfo = addInfos[n];
      if (addInfo.startsWith(aKey) == false) continue;
  ...
  public boolean isThumbnail() {
    ...
    if (dlnaOrgPn == null) return false;
    if (dlnaOrgPn.endsWith("_TN")) return true;
    return false;
  }
  ...
  public boolean isSmallImage() {
    String dlnaOrgPn = getDlnaOrgPn();
    if (dlnaOrgPn == null) return false;
    if (dlnaOrgPn.endsWith("_SM")) return true;
    return false;
  }
  ...
  public boolean isMediumImage() {
    String dlnaOrgPn = getDlnaOrgPn();
    if (dlnaOrgPn == null) return false;
    if (dlnaOrgPn.endsWith("_MED")) return true;
    return false;
  }
  ...
  public boolean isLargeImage() {
    String dlnaOrgPn = getDlnaOrgPn();
    if (dlnaOrgPn == null) return false;
    if (dlnaOrgPn.endsWith("_LRG")) return true;
    return false;
  }
  ...
  public boolean isMovie() {
    String mimeType = getContentFormat();
    if (mimeType == null) return false;
    if (mimeType.startsWith("movie")) return true;
