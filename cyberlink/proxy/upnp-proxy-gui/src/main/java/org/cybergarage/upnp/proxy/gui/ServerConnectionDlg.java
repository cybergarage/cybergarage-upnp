...
public class ServerConnectionDlg extends JDialog implements ActionListener
{
	...
	public ServerConnectionDlg(Frame frame)
	{
		super(frame, true);
		...
		staticLabel = new JLabel("Host");
		hostLabel = new JTextField();
		argListPane.add(staticLabel);
		argListPane.add(hostLabel);
